...
ARGUMENTS="-D MAC -std=c++20 -shared -undefined dynamic_lookup `pkg-config --libs sdl3`" 

# Which directories do we want to include.
INCLUDE_DIR="-I ./include/ -I./pybind11/include/ -I/Library/Frameworks/SDL3.framework/Headers `python3.9 -m pybind11 --includes`"
